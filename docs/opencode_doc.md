...
Если навык не отображается:
    ...
    Убедитесь, что SKILL.md написано заглавными буквами.
    Убедитесь, что заголовок включает name и description.
    Убедитесь, что названия навыков уникальны во всех локациях.
    Проверьте разрешения — навыки с deny скрыты от агент
